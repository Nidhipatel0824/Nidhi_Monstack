                    ...
                    <div className="container py-5">
                        ...
                        <nav aria-label="breadcrumb animated slideInDown">
                            <ol className="breadcrumb">
                                <li className="breadcrumb-item"><a className="text-black" href="#">Home</a></li>
                                <li className="breadcrumb-item"><a className="text-black" href="#">Pages</a></li>
                                <li className="breadcrumb-item text-black active" aria-current="page">About</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                    ...
                    <div className="container">
                        ...
                        <div className="row g-4">
                            ...
                            <div className="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                                <div className="team-item">
                                    <div className="overflow-hidden position-relative">
                                        <img className="img-fluid" src="img/team-3.jpg" alt="img3"/>
                                        <div className="team-social">
                                            <a className="btn btn-square" href><i className="fab fa-facebook-f" /></a>
                                            <a className="btn btn-square" href><i className="fab fa-twitter" /></a>
                                            <a className="btn btn-square" href><i className="fab fa-instagram" /></a>
                            ...
                            <div className="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
                                <div className="team-item">
                                    <div className="overflow-hidden position-relative">
                                        <img className="img-fluid" src="img/team-4.jpg" alt="img4" />
                                        <div className="team-social">
                                            <a className="btn btn-square" href><i className="fab fa-facebook-f" /></a>
                                            <a className="btn btn-square" href><i className="fab fa-twitter" /></a>
                                            <a className="btn btn-square" href><i className="fab fa-instagram" /></a>
